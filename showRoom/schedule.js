...
shopRank();
weather();
// exports.weatherdata = weatherdata2;
// function weather(){
// 	schedule.scheduleJob(test,async function(){
// 		for(var i =0 ; i<options.length; i++){
			
// 			let temp = {};
// 			await request(options[i]).then(async function(response){
// 				var result1 = JSON.parse(response);
// 				temp.city = weatherdata[i]; 
// 				temp.tc = result1.weather.hourly[0].temperature.tc;
// 				temp.tmax = result1.weather.hourly[0].temperature.tmax;
// 				temp.tmin = result1.weather.hourly[0].temperature.tmin;

// 				var city = weatherdata[i];
// 				console.log(city);
// 			    let weatherData = {
// 			        tc : result1.weather.hourly[0].temperature.tc,
// 			        tmax : result1.weather.hourly[0].temperature.tmax,
// 			        tmin : result1.weather.hourly[0].temperature.tmin
// 			    }; 
// 			    weaherInsert : 'update weather set ? where city=?',
// 			    console.log(weaherInsert)
// 				upd = await dbModel.dbOverlap2(weaherInsert,[weatherData,city]);
// 				console.log(upd)    
//     			weatherdata2.push(temp);
// 			});
// 		}
// 	})
// }